(() => {
  ...
  css.textContent=`
    ...
    @media(max-width:1000px){.v58-work{grid-template-columns:150px minmax(0,1fr)}.v58-panel{display:none}.v58-stage{padding:15px}.v58-social-wrap{grid-template-columns:1fr}.v58-caption{max-width:620px;margin:0 auto;width:100%}}@media(max-width:700px){#v58-suite{left:0}.v58-work{grid-template-columns:1fr}.v58-nav{display:none}.v58-stage{padding:8px}.v58-top select,.v58-saved{display:none}.v58-doc{padding:35px 24px}.v58-web-cards,.v58-web-stats{grid-template-columns:1fr}.v58-webnav .v58-links{display:none}}
