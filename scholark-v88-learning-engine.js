(() => {
  ...
  const level=()=>localStorage.getItem('scholark_learning_level')||'secondary',language=()=>localStorage.getItem('scholark_ui_language')||document.documentElement.lang||'English';
