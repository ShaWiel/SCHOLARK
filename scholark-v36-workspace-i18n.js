(() => {
  ...
  const labels={
    ...
    srn:{home:'Home',dashboard:'Dashboard',education:'Skoro nanga leri',projects:'Mi projekti',tutor:'AI Tutor',studio:'Studio AI',planner:'Planner',progress:'Progress',goals:'Goals',logout:'Go komopo',focus:'Focus mode',reset:'Reset demo'},
