...
ok(schoolClient.includes("labels.upper+' · VOS / HAVO'")&&!schoolClient.includes("labels.upper+' · VOS / HAVO / VWO'"),'School upper-secondary label still bundles VWO');
ok(schoolVwo.includes("const VERSION='20260918-school-vwo-v5'"),'VWO frontend module version is stale');
