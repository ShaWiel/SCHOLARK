...
ok(i18n.includes("dynamic=!STATIC_CORE_LANGS.has(target)")&&i18n.includes("home?collectDom(340):[...CORE,...collectDom(480)]")&&i18n.includes("scheduleLanguageCompletion(target,epoch,uiSignal)"),'Dynamic first-use translation priming is incomplete');
