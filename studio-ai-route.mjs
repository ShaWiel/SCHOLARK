...
function buildContext(payload) {
  ...
  const maxItems = mode === 'presentation' ? 100 : mode === 'presentation_slide_edit' ? 1 : mode === 'presentation_block_edit' ? 1 : mode === 'document_section_edit' ? 1 : mode === 'book' ? 60 : mode === 'book_chapter' ? 12 : 40;
