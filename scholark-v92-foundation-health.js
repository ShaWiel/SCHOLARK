(() => {
  ...
  async function runSelftest(){
    ...
    const checks={
      ...
      cloudApi:!workspaceNeeded||!!window.__SCHOLARK_V72_CLOUD__,connectedCore:!workspaceNeeded||!!window.__SCHOLARK_WORKSPACE_CORE__,connectedExperience:!workspaceNeeded||!!window.__SCHOLARK_V111_EXPERIENCE__,visualSystem:!workspaceNeeded||r==='dashboard'||!!window.__SCHOLARK_V112_VISUAL__,orchestrator:!workspaceNeeded||!!window.__SCHOLARK_V114_ORCHESTRATOR__,hardening:!!(window.__SCHOLARK_HARDENING__||window.__SCHOLARK_FOUNDATION_R176__||window.__SCHOLARK_FOUNDATION_R175__||window.__SCHOLARK_FOUNDATION_R174__||window.__SCHOLARK_FOUNDATION_R173__||window.__SCHOLARK_FOUNDATION_R172__),i18n:!!window.__SCHOLARK_I18N__,countryFoundation:!!window.__SCHOLARK_COUNTRY__,
    ...
    const paths=['/api/health','/api/guard/health','/api/learning/health','/api/export/health','/api/schools/health','/api/schools/resilience'];
