...
const VERSION='20260925-school-global-v8';
...
const SRC_ECOIS='https://ecois.sr/portfolio/de-nieuwe-leerkracht-2/';
const SRC_CPI='https://cpisuriname.wordpress.com/about/';
const SRC_POLICY_2024='https://gov.sr/wp-content/uploads/2025/03/Nationaal-Onderwijsbeleidsplan-Suriname-2024-2031-DEF-1-Correct.docx.pdf';
const SURINAME_CURATED_RAW=[
  ...
  // Current 2026 GOV.SR vocational-school directory additions.
  {name:'Avond LBO SATS-Lelydorp',exact:['lbo'],description:'Tjamelielaan 2 · Lelydorp · LBO',city:'Lelydorp',district:'Wanica',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Avond LBO SATS-Meerzorg',exact:['lbo'],description:'Commissaris Thurkowweg 32 · Meerzorg · LBO/PO',city:'Meerzorg',district:'Commewijne',phone:'+597 401003',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Avond LBO SATS-Saramacca',exact:['lbo'],description:'Saramacca · LBO/PO',district:'Saramacca',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'J.G.A. Koendersschool',exact:['lbo'],description:'Marowijnestraat 12-14 · Beekhuizen · LBO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Avond LBO SATS-Nickerie',exact:['lbo'],description:'Nieuw Nickerie · LBO',city:'Nieuw Nickerie',district:'Nickerie',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'LBO Barron',exact:['lbo'],description:'Lijnweg · Marowijne · LBO/PO',district:'Marowijne',phone:'+597 341315',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'H.J. de Vriesschool',exact:['lbo'],description:'Von Freyburg km 55 · Saramacca · LBO',district:'Saramacca',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET,aliases:'H.J de Vriesschool'},
  {name:'Avond LBO SATS-Klaaskreek',exact:['lbo'],description:'Klaaskreek · Brokopondo · LBO',city:'Klaaskreek',district:'Brokopondo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Pandit Kalidienschool',exact:['lbo'],description:'Commissaris Thurkowweg 6 · Commewijne · LBO',district:'Commewijne',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Surinaamse Technische School Nickerie (STS-N)',exact:['lbo'],description:'Van Pettenpolder · Nickerie · LBO/PO',district:'Nickerie',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET,aliases:'Surinaamse Technische School -Nickerie; STS-N'},
  {name:'LBO Brokopondo',exact:['lbo'],description:'Mamadamweg 24-25 · Brokopondo · LBO',city:'Brokopondo',district:'Brokopondo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'C.A. van Sypesteynschool',exact:['lbo'],description:'Mauriciusstraat 25-27 · Rainville · LBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 471570',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'L.A. Simonsschool',exact:['lbo'],description:'Verlengde Gemenelandsweg 270 · Flora · LBO/PO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET,aliases:'L.A.Simonsschool'},
  {name:'LBO Wit Santi',exact:['lbo'],description:'Jan Starkelaan 1 · Zanderij · LBO',city:'Zanderij',district:'Para',phone:'+597 325521',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Surinaamse Technische School 4 (STS-4)',exact:['lbo'],description:'Difoestraat · Blauwgrond · LBO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'LBO Stoelmanseiland',exact:['lbo'],description:'Stoelmanseiland · Sipaliwini · LBO',city:'Stoelmanseiland',district:'Sipaliwini',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'LBO Beekhuyzen',exact:['lbo'],description:'Gronfolostraat 28 · Beekhuizen · LBO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET,aliases:'LBO Beekhuizen'},
  {name:'Giovanni Montinischool',exact:['lbo'],description:'La Vigilante · Paranam · LBO',city:'Paranam',district:'Para',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'George Alexander Kortschool',exact:['lbo'],description:'La Vigilante · Paranam · LBO',city:'Paranam',district:'Para',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'LBO Openbare Nijverheidschool (ONS)',exact:['lbo'],description:'Dr. Samuel Kafiludistraat 64 · Paramaribo · LBO/PO',city:'Paramaribo',district:'Paramaribo',phone:'+597 497404',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Surinaamse Technische School 3 (STS-3)',exact:['lbo'],description:'Kankantriestraat 14 · Beekhuizen · LBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 402705',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Surinaamse Technische School 2 (STS-2)',exact:['lbo'],description:'Verlengde Jaggernath Lachmonstraat 180 · Tammenga · LBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 498290',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Avond LBO SATS/ATV Paramaribo',exact:['lbo'],description:'Passiebloemstraat · Paramaribo · LBO/PO',city:'Paramaribo',district:'Paramaribo',phone:'+597 401003',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'LBO Nw. Dominee',exact:['lbo'],description:'Nepveustraat 2 · Paramaribo · LBO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET,aliases:'LBO Nieuwe Dominee'},
  {name:'Theodoor Judaschool',exact:['lbo'],description:'Zinniastraat 19-21 · Paramaribo · LBO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'LBO Tata Colin',exact:['lbo'],description:'Gouverneurstraat · Coronie · LBO',district:'Coronie',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'LBO Hockey',exact:['lbo'],description:'Hockeystraat 31 · Latour · LBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 482111',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET,aliases:'Hockeyschool'},
  {name:'E.H. Cabellschool',exact:['lbo'],description:'Kwattaweg 636 · Weg naar Zee · LBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 436232',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Waaldijk College',exact:['lbo'],description:'Frederik Derbystraat · Paramaribo · LBO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  ...
  {name:'AMTO Noord',exact:['mbo'],description:'Difoestraat · Paramaribo · MBO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'NATIN Nickerie',exact:['mbo'],description:'Aloepistraat 2-5 · Nieuw Nickerie · MBO',city:'Nieuw Nickerie',district:'Nickerie',phone:'+597 212411',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'NATIN Lelydorp',exact:['mbo'],description:'Mawarlaan 17 · Lelydorp · MBO',city:'Lelydorp',district:'Wanica',phone:'+597 6808019',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'MBO Para (IMEAO)',exact:['mbo'],description:'Joris Klasweg · Para · MBO',district:'Para',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'NATIN Mottonshoop',exact:['mbo'],description:'Iduweg 2 (Kasabaholoweg) · Tammenga · Paramaribo · MBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 539190',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'NATIN Leysweg',exact:['mbo'],description:'Leysweg · Tammenga · Paramaribo · MBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 498737',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'IMEAO 3',exact:['mbo'],description:'Noordpoolweg 11a · De Nieuwe Grond · MBO',district:'Wanica',phone:'+597 486116',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'IMEAO 1',exact:['mbo'],description:'Joli Coeurstraat 1 · Blauwgrond · Paramaribo · MBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 452355',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'IMEAO Nickerie',exact:['mbo'],description:'Julianastraat 100 · Nieuw Nickerie · MBO',city:'Nieuw Nickerie',district:'Nickerie',phone:'+597 231573',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'AMTO Nickerie',exact:['mbo'],description:'Aloepistraat · Nieuw Nickerie · MBO',city:'Nieuw Nickerie',district:'Nickerie',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'IMEAO 4',exact:['mbo'],description:'Gitaarstraat 28 · Kwatta · MBO',city:'Kwatta',district:'Wanica',phone:'+597 437054',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},
  {name:'Vocational College Suriname (VCS)',exact:['mbo'],description:'Dr. S. Kafiludistraat · Paramaribo · MBO',city:'Paramaribo',district:'Paramaribo',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET,aliases:'VCS'},
  {name:'Avond IMEAO',exact:['mbo'],description:'Passiebloemstraat 1 · Paramaribo · MBO',city:'Paramaribo',district:'Paramaribo',phone:'+597 401022',source:'MinOWC Directoraat Beroepsonderwijs 2026',sourceUrl:SRC_TVET},

  // Pedagogical institutes / teacher training. DNL is documented as a four-year MBO programme.
  {name:'Albert Cameron Instituut (ACI)',exact:['mbo'],description:'Metaalstraat 10 · Paramaribo · Pedagogisch instituut / De Nieuwe Leerkracht (MBO)',city:'Paramaribo',district:'Paramaribo',source:'ECOIS De Nieuwe Leerkracht',sourceUrl:SRC_ECOIS,aliases:'ACI; Albert Cameron Institute'},
  {name:'Christelijk Pedagogisch Instituut (CPI)',exact:['mbo'],description:'Nengrekopoestraat · Paramaribo · De Nieuwe Leerkracht (MBO)',city:'Paramaribo',district:'Paramaribo',phone:'+597 476544',website:'https://cpisuriname.wordpress.com/',source:'CPI official + ECOIS',sourceUrl:SRC_CPI,aliases:'CPI'},
  {name:'Pedagogisch Instituut Nickerie (PIN)',exact:['mbo'],description:'Julianastraat 100 · Nieuw Nickerie · De Nieuwe Leerkracht (MBO)',city:'Nieuw Nickerie',district:'Nickerie',source:'ECOIS + Nuffic',sourceUrl:SRC_ECOIS,aliases:'PIN; Kweekschool Nickerie'},
  {name:'Surinaams Pedagogisch Instituut (SPI)',exact:['mbo'],description:'Paramaribo · De Nieuwe Leerkracht / lerarenopleiding',city:'Paramaribo',district:'Paramaribo',website:'https://sites.google.com/view/spi-educatie/home',source:'SPI official + ECOIS',sourceUrl:SRC_ECOIS,aliases:'SPI; Surinaamse Pedagogische Instituut'},
  {name:'Avondopleiding De Nieuwe Leerkracht (ADNL)',exact:['mbo'],description:'Jaggernath Lachmonstraat · Paramaribo · avondopleiding leraren basisonderwijs',city:'Paramaribo',district:'Paramaribo',phone:'+597 498579',source:'Nuffic + current school listing',sourceUrl:SRC_NUFFIC,aliases:'ADNL; Avondopleiding voor de Onderwijzersakte'},
  ...
  {name:'Scholengemeenschap Moengotapoe',exact:['havo','vwo','mbo'],description:'Moengotapoe · Marowijne · geaccrediteerd HAVO/VWO',city:'Moengotapoe',district:'Marowijne',source:'Nuffic current accreditation overview',sourceUrl:SRC_NUFFIC},
  ...
  {name:'FHR Institute for Higher Education',exact:['hbo'],description:'Mr. F.H.R. Lim A Postraat 8-10 · Paramaribo · gespecialiseerde hogeronderwijsinstelling met geaccrediteerde bachelor- en masteropleidingen',city:'Paramaribo',district:'Paramaribo',website:'https://www.fhrinstitute.sr/',phone:'+597 425101',source:'Nuffic + NOVA current accreditation register',sourceUrl:SRC_NOVA,aliases:'FHR Institute for Social Studies; FHR'},
...
async function nominatimSchoolFallback(country,city,center,countryCode,countryWide){
  ...
  for(let qi=0;qi<queries.length;qi++){
    try{
      ...
      const r=await timedFetch(u,{headers:{accept:'application/json','user-agent':'SCHOLARK/1.0 global-school-fallback'}},9000);if(!r.ok)continue;
    ...
    if(qi+1<queries.length)await new Promise(r=>setTimeout(r,900));
  }
