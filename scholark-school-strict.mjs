...
const SURINAME_CURATED_RAW=[
  ...
  {name:'FHR Institute for Higher Education',exact:['hbo','wo'],description:'Mr. F.H.R. Lim A Postraat 8-10 · Paramaribo · HBO bachelor en geaccrediteerde WO-masteropleidingen',city:'Paramaribo',district:'Paramaribo',website:'https://www.fhrinstitute.sr/',phone:'+597 425101',source:'Nuffic + NOVA current accreditation register',sourceUrl:SRC_NOVA,aliases:'FHR Institute for Social Studies; FHR'},
