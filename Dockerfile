...
COPY scholark-school-strict.mjs /app/scholark-school-strict.mjs
...
COPY scholark-v24-ui.js \
     ...
     scholark-v101-core-foundation.js \
     scholark-v102-language-quiz.js \
     scholark-v103-language-next-lesson.js \
     scholark-v104-school-filter-guard.js \
     /tmp/

RUN node --check /tmp/scholark-v105-school-vwo.js \
    ...
    && find /app -type f -name '*.html' -exec sh -c 'dir=$(dirname "$1"); for f in /tmp/scholark-v*.js; do cp "$f" "$dir/$(basename "$f")"; done; cp /tmp/scholark-runtime-loader.js "$dir/scholark-runtime-loader.js"; sed -i "s#</body>#<script defer src=\"scholark-runtime-loader.js?v=20260918-r137\"></script><script defer src=\"scholark-v100-home-cinematics.js?v=20260910-r136\"></script><script defer src=\"scholark-v101-core-foundation.js?v=20260918-r137\"></script><script defer src=\"scholark-v102-language-quiz.js?v=20260916-language-choice-v2\"></script><script defer src=\"scholark-v103-language-next-lesson.js?v=20260917-language-next-v1\"></script><script defer src=\"scholark-v104-school-filter-guard.js?v=20260918-school-filter-v2\"></script><script defer src=\"scholark-v105-school-vwo.js?v=20260918-school-vwo-v5\"></script></body>#" "$1"' sh {} \; \
