(() => {
  ...
  const LANGS=[
    ...
    ['af','Afrikaans','Afrikaans'],['sq','Shqip','Albanian'],['am','አማርኛ','Amharic'],['hy','Հայերեն','Armenian'],
    ['az','Azərbaycan dili','Azerbaijani'],['eu','Euskara','Basque'],['be','Беларуская','Belarusian'],['bs','Bosanski','Bosnian'],
    ['bg','Български','Bulgarian'],['ca','Català','Catalan'],['hr','Hrvatski','Croatian'],['et','Eesti','Estonian'],
    ['ka','ქართული','Georgian'],['gu','ગુજરાતી','Gujarati'],['is','Íslenska','Icelandic'],['ga','Gaeilge','Irish'],
    ['kk','Қазақша','Kazakh'],['km','ខ្មែរ','Khmer'],['lo','ລາວ','Lao'],['lv','Latviešu','Latvian'],
    ['lt','Lietuvių','Lithuanian'],['mk','Македонски','Macedonian'],['ml','മലയാളം','Malayalam'],['mr','मराठी','Marathi'],
    ['mn','Монгол','Mongolian'],['ne','नेपाली','Nepali'],['ps','پښتو','Pashto'],['sr','Српски','Serbian'],
    ['sk','Slovenčina','Slovak'],['sl','Slovenščina','Slovenian'],['so','Soomaali','Somali'],['si','සිංහල','Sinhala'],
    ['uz','Oʻzbekcha','Uzbek'],['cy','Cymraeg','Welsh'],['yo','Yorùbá','Yoruba'],['zu','isiZulu','Zulu'],
    ['ha','Hausa','Hausa']
  ];
  ...
  [
    ...
    ['Create with ARKI','Maak met ARKI','Crear con ARKI','Créer avec ARKI','Mit ARKI erstellen','Criar com ARKI','Crea con ARKI'],
    ...
    ['74-language interface','Interface in 74 talen','Interfaz en 74 idiomas','Interface en 74 langues','Oberfläche in 74 Sprachen','Interface em 74 idiomas','Interfaccia in 74 lingue'],
    ...
    ['All school types','Alle schooltypen','Todos los tipos de escuela','Tous les types d’école','Alle Schultypen','Todos os tipos de escola','Tutti i tipi di scuola'],
    ['Public','Openbaar','Openbare','Public','Öffentlich','Pública','Pubblica'],
    ['Private','Particulier','Privada','Privé','Privat','Privada','Privata'],
    ['Special / religious','Bijzonder / religieus','Especial / religiosa','Spécial / religieux','Besonders / religiös','Especial / religiosa','Speciale / religiosa'],
    ['International','Internationaal','Internacional','International','International','Internacional','Internazionale'],
    ['Verified only','Alleen geverifieerd','Solo verificados','Vérifiés uniquement','Nur verifiziert','Somente verificados','Solo verificati'],
    ['Best match first','Beste match eerst','Mejor coincidencia primero','Meilleure correspondance d’abord','Beste Übereinstimmung zuerst','Melhor correspondência primeiro','Migliore corrispondenza prima'],
    ['Nearest first','Dichtstbijzijnde eerst','Más cercanas primero','Les plus proches d’abord','Nächste zuerst','Mais próximas primeiro','Più vicine prima'],
    ['Name A–Z','Naam A–Z','Nombre A–Z','Nom A–Z','Name A–Z','Nome A–Z','Nome A–Z'],
    ['Saved schools','Bewaarde scholen','Escuelas guardadas','Écoles enregistrées','Gespeicherte Schulen','Escolas salvas','Scuole salvate'],
    ['Official site','Officiële website','Sitio oficial','Site officiel','Offizielle Website','Site oficial','Sito ufficiale'],
    ['View reviews','Bekijk beoordelingen','Ver reseñas','Voir les avis','Bewertungen ansehen','Ver avaliações','Vedi recensioni'],
    ['Research school','Onderzoek school','Investigar escuela','Rechercher l’école','Schule recherchieren','Pesquisar escola','Ricerca scuola'],
    ['Map','Kaart','Kaart','Carte','Karte','Mapa','Mappa'],
    ['About','Info','Acerca de','À propos','Info','Sobre','Info'],
    ['Match','Match','Coincidencia','Correspondance','Übereinstimmung','Correspondência','Corrispondenza'],
    ['Custom minutes (5–240)','Aangepaste minuten (5–240)','Minutos personalizados (5–240)','Minutes personnalisées (5–240)','Benutzerdefinierte Minuten (5–240)','Minutos personalizados (5–240)','Minuti personalizzati (5–240)'],
    ['Export cards','Kaarten exporteren','Exportar tarjetas','Exporter les cartes','Karten exportieren','Exportar cartões','Esporta carte'],
    ['Shuffle due cards before review.','Schud de kaarten die aan de beurt zijn vóór de review.','Mezclar las tarjetas pendientes antes de repasar.','Mélanger les cartes dues avant la révision.','Fällige Karten vor der Wiederholung mischen.','Embaralhar cartões pendentes antes da revisão.','Mescola le carte dovute prima del ripasso.'],
    ['Export CSV','CSV exporteren','Exportar CSV','Exporter CSV','CSV exportieren','Exportar CSV','Esporta CSV'],
    ['Export calendar (.ics)','Agenda exporteren (.ics)','Exportar calendario (.ics)','Exporter le calendrier (.ics)','Kalender exportieren (.ics)','Exportar calendário (.ics)','Esporta calendario (.ics)'],
    ['Clear completed','Voltooide items wissen','Borrar completadas','Effacer les éléments terminés','Erledigte löschen','Limpar concluídos','Cancella completati'],
    ['Export progress snapshot','Voortgangsoverzicht exporteren','Exportar resumen de progreso','Exporter l’aperçu des progrès','Fortschrittsübersicht exportieren','Exportar resumo do progresso','Esporta riepilogo progressi'],
    ['High priority','Hoge prioriteit','Alta prioridad','Priorité élevée','Hohe Priorität','Alta prioridade','Priorità alta'],
    ['Medium priority','Gemiddelde prioriteit','Prioridad media','Priorité moyenne','Mittlere Priorität','Prioridade média','Priorità media'],
    ['Low priority','Lage prioriteit','Prioridad baja','Priorité faible','Niedrige Priorität','Baixa prioridade','Priorità bassa'],
  ...
  [
    ...
    ["Balanced","Gebalanceerd","Equilibrado","Équilibré","Ausgewogen","Equilibrado","Bilanciato"],
    ["Highest quality · PRO","Hoogste kwaliteit · PRO","Máxima calidad · PRO","Qualité maximale · PRO","Höchste Qualität · PRO","Qualidade máxima · PRO","Massima qualità · PRO"],
    ["GENERATOR-FIRST","GENERATOR-EERST","GENERADOR PRIMERO","GÉNÉRATEUR D’ABORD","GENERATOR ZUERST","GERADOR PRIMEIRO","GENERATORE PRIMA"],
    ["Building roadmap…","Roadmap wordt opgebouwd…","Creando la hoja de ruta…","Création de la feuille de route…","Roadmap wird erstellt…","Criando o roteiro…","Creazione della roadmap…"],
    ["Skills to build","Vaardigheden om op te bouwen","Habilidades a desarrollar","Compétences à développer","Fähigkeiten zum Aufbau","Competências a desenvolver","Competenze da sviluppare"],
    ["Key subjects","Belangrijke vakken","Materias clave","Matières clés","Wichtige Fächer","Disciplinas principais","Materie chiave"],
    ["Books & resources","Boeken & bronnen","Libros y recursos","Livres et ressources","Bücher & Ressourcen","Livros e recursos","Libri e risorse"],
    ["University preparation","Voorbereiding op de universiteit","Preparación universitaria","Préparation universitaire","Universitätsvorbereitung","Preparação universitária","Preparazione universitaria"],
    ["Career directions","Carrièrerichtingen","Direcciones profesionales","Pistes de carrière","Karriererichtungen","Direções de carreira","Percorsi professionali"],
    ["Your roadmap","Jouw roadmap","Tu hoja de ruta","Votre feuille de route","Deine Roadmap","Seu roteiro","La tua roadmap"],
    ["Generate chapter draft","Genereer hoofdstukversie","Generar borrador del capítulo","Générer le brouillon du chapitre","Kapitelentwurf erstellen","Gerar rascunho do capítulo","Genera la bozza del capitolo"],
    ["Regenerate chapter draft","Genereer hoofdstuk opnieuw","Regenerar borrador del capítulo","Régénérer le brouillon du chapitre","Kapitelentwurf neu erstellen","Regenerar rascunho do capítulo","Rigenera la bozza del capitolo"],
    ["Continuity & purpose","Continuïteit & doel","Continuidad y propósito","Continuité et objectif","Kontinuität & Zweck","Continuidade e propósito","Continuità e scopo"],
    ["Mood / research direction","Sfeer / onderzoeksrichting","Tono / dirección de investigación","Ambiance / direction de recherche","Stimmung / Rechercherichtung","Clima / direção de pesquisa","Atmosfera / direzione di ricerca"],
    ["Export DOCX","DOCX exporteren","Exportar DOCX","Exporter en DOCX","DOCX exportieren","Exportar DOCX","Esporta DOCX"],
    ["Export PDF","PDF exporteren","Exportar PDF","Exporter en PDF","PDF exportieren","Exportar PDF","Esporta PDF"],
    ["Presentation Studio","Presentatiestudio","Estudio de presentaciones","Studio Présentation","Präsentationsstudio","Estúdio de apresentações","Studio Presentazioni"],
    ["Webpage Studio","Webpagestudio","Estudio de páginas web","Studio Page web","Webseitenstudio","Estúdio de páginas web","Studio Pagine web"],
    ["Document Studio","Documentstudio","Estudio de documentos","Studio Document","Dokumentstudio","Estúdio de documentos","Studio Documenti"],
    ["Social Studio","Social-studio","Estudio social","Studio Social","Social-Studio","Estúdio social","Studio Social"],
    ["Graphic Studio","Graphic-studio","Estudio gráfico","Studio Graphique","Grafikstudio","Estúdio gráfico","Studio Grafica"],
    ["Number of slides","Aantal slides","Número de diapositivas","Nombre de diapositives","Anzahl der Folien","Número de slides","Numero di slide"],
    ["Aspect ratio","Beeldverhouding","Relación de aspecto","Format d’image","Seitenverhältnis","Proporção","Proporzioni"],
    ["Audience","Doelgroep","Público","Public","Zielgruppe","Público","Pubblico"],
    ["Speaker notes","Sprekersnotities","Notas del presentador","Notes du présentateur","Sprechernotizen","Notas do apresentador","Note del relatore"],
    ["Page type","Paginatype","Tipo de página","Type de page","Seitentyp","Tipo de página","Tipo di pagina"],
    ["Sections","Secties","Secciones","Sections","Abschnitte","Seções","Sezioni"],
    ["Layout","Lay-out","Diseño","Mise en page","Layout","Layout","Layout"],
    ["SEO structure","SEO-structuur","Estructura SEO","Structure SEO","SEO-Struktur","Estrutura SEO","Struttura SEO"],
    ["CTA strategy","CTA-strategie","Estrategia de CTA","Stratégie CTA","CTA-Strategie","Estratégia de CTA","Strategia CTA"],
    ["Document type","Documenttype","Tipo de documento","Type de document","Dokumenttyp","Tipo de documento","Tipo di documento"],
    ["Target length","Doellengte","Longitud objetivo","Longueur cible","Ziellänge","Extensão alvo","Lunghezza obiettivo"],
    ["Citation style","Citatiestijl","Estilo de citas","Style de citation","Zitierstil","Estilo de citação","Stile di citazione"],
    ["Research with sources","Onderzoek met bronnen","Investigación con fuentes","Recherche avec sources","Recherche mit Quellen","Pesquisa com fontes","Ricerca con fonti"],
    ["Platform","Platform","Plataforma","Plateforme","Plattform","Plataforma","Piattaforma"],
    ["Deliverables","Opleveringen","Entregables","Livrables","Ergebnisse","Entregáveis","Output"],
    ["Format","Formaat","Formato","Format","Format","Formato","Formato"],
    ["Graphic type","Graphic-type","Tipo de gráfico","Type de visuel","Grafiktyp","Tipo de gráfico","Tipo di grafica"],
    ["Canvas","Canvas","Lienzo","Canevas","Arbeitsfläche","Tela","Canvas"],
    ["Variants","Varianten","Variantes","Variantes","Varianten","Variantes","Varianti"],
    ["Genre / type","Genre / type","Género / tipo","Genre / type","Genre / Typ","Gênero / tipo","Genere / tipo"],
    ["Custom genre blend (optional)","Eigen genrecombinatie (optioneel)","Mezcla de géneros personalizada (opcional)","Mélange de genres personnalisé (facultatif)","Eigener Genre-Mix (optional)","Mistura de gêneros personalizada (opcional)","Mix di generi personalizzato (opzionale)"],
    ["Target words","Doelaantal woorden","Palabras objetivo","Nombre de mots cible","Zielwortzahl","Palavras-alvo","Numero di parole obiettivo"],
    ["POV","Perspectief","Punto de vista","Point de vue","Perspektive","Ponto de vista","Punto di vista"],
    ["Chapter strategy","Hoofdstukstrategie","Estrategia de capítulos","Stratégie des chapitres","Kapitelstrategie","Estratégia de capítulos","Strategia dei capitoli"],
    ["Story / knowledge bible","Verhaal- / kennisbijbel","Biblia de historia / conocimiento","Bible d’histoire / de connaissances","Story- / Wissensbibel","Bíblia de história / conhecimento","Bibbia narrativa / di conoscenza"],
    ["Writing coach + what comes next","Schrijfcoach + wat hierna komt","Coach de escritura + qué sigue","Coach d’écriture + prochaine étape","Schreibcoach + nächster Schritt","Coach de escrita + próximos passos","Coach di scrittura + cosa viene dopo"],
    ["waiting","wachten","esperando","en attente","wartet","aguardando","in attesa"],
    ["working","bezig","trabajando","en cours","in Arbeit","processando","in lavorazione"],
    ["complete","voltooid","completo","terminé","abgeschlossen","concluído","completato"],
    ["Outline ready. You can now generate the complete first draft.","Outline klaar. Je kunt nu de volledige eerste versie genereren.","Esquema listo. Ahora puedes generar el primer borrador completo.","Plan prêt. Vous pouvez maintenant générer la première version complète.","Gliederung fertig. Du kannst jetzt den vollständigen ersten Entwurf erstellen.","Esboço pronto. Agora você pode gerar o primeiro rascunho completo.","Scaletta pronta. Ora puoi generare la prima bozza completa."],
    ["Describe what you want to create first.","Beschrijf eerst wat je wilt maken.","Describe primero lo que quieres crear.","Décrivez d’abord ce que vous voulez créer.","Beschreibe zuerst, was du erstellen möchtest.","Descreva primeiro o que você quer criar.","Descrivi prima cosa vuoi creare."],
  ...
  const CORE=[
    ...
    'CHAT HISTORY','+ New chat','Local chat mode.','Sign in','to sync chat history across devices.','No saved chats yet.','Ask SCHOLARK anything you want to learn...','Ask ARKI',
    ...
    'AI Tutor with step-by-step lessons','Diagnostics, Mastery & Spaced Review','Planner, Goals & Progress','Files & Notes analysis','Language Learner: vocabulary, grammar, listening & speaking practice','74-language interface','30 included AI credits/month','Credits are spent only on AI-heavy actions',
    ...
    'Everything in Plus','Highest-quality ARKI','Generous Studio + Natural Rewrite with fair-use guardrails','Presentations up to 100 slides','Documents/reports up to 100 pages','Book Studio beta: architecture + chapter-by-chapter writing','All genres + custom blends','Schools Near Me + Study Ahead','2,500 included AI credits/month','Priority access to stronger models for complex work',
  ...
  function scheduleUnknown(){
    if(code()==='en')return;
    clearTimeout(unknownTimer);unknownTimer=setTimeout(fillUnknown,isHomeRoute()?760:300);
  }
  ...
  function i18nSelftest(){
    const required=['Dashboard','Your learning & creation workspace.','Learn faster. Create better.','Get ahead.','Know where you are going before you get there.','SCHOLARK PLANS','Choose how much advantage you want.','Go to Workspace','Education & Learning'];
    ...
    const rtlReady=['ar','he','ur','fa','ps'].every(x=>RTL.has(x));
