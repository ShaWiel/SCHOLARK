(() => {
  ...
  [
    ['SCHOLARK LANGUAGE','SCHOLARK TAAL','IDIOMA SCHOLARK','LANGUE SCHOLARK','SCHOLARK SPRACHE','IDIOMA SCHOLARK','LINGUA SCHOLARK'],
    ['Create from a brief, not a blank page.','Maak vanuit een briefing, niet vanaf een lege pagina.','Crea desde un brief, no desde una página en blanco.','Créez à partir d’un brief, pas d’une page blanche.','Erstelle aus einem Briefing statt von einer leeren Seite.','Crie a partir de um briefing, não de uma página em branco.','Crea da un brief, non da una pagina vuota.'],
    ['Structure, research, writing, design and quality control in one creator workspace.','Structuur, onderzoek, schrijven, design en kwaliteitscontrole in één creator-werkruimte.','Estructura, investigación, redacción, diseño y control de calidad en un solo espacio creativo.','Structure, recherche, rédaction, design et contrôle qualité dans un seul espace créatif.','Struktur, Recherche, Schreiben, Design und Qualitätskontrolle in einem Creator-Arbeitsbereich.','Estrutura, pesquisa, escrita, design e controlo de qualidade num só espaço criativo.','Struttura, ricerca, scrittura, design e controllo qualità in un unico spazio creativo.'],
    ['Creation settings','Creatie-instellingen','Ajustes de creación','Paramètres de création','Erstellungseinstellungen','Definições de criação','Impostazioni di creazione'],
    ['Output language','Uitvoertaal','Idioma de salida','Langue de sortie','Ausgabesprache','Idioma de saída','Lingua di output'],
    ['AI quality','AI-kwaliteit','Calidad de IA','Qualité IA','KI-Qualität','Qualidade da IA','Qualità IA'],
    ['Style / tone','Stijl / toon','Estilo / tono','Style / ton','Stil / Ton','Estilo / tom','Stile / tono'],
    ['Deep quality pipeline','Diepe kwaliteitspipeline','Pipeline de alta calidad','Pipeline qualité approfondie','Tiefe Qualitätspipeline','Pipeline de qualidade avançada','Pipeline di qualità avanzata'],
    ['Describe exactly what you want SCHOLARK to create…','Beschrijf precies wat je wilt dat SCHOLARK maakt…','Describe exactamente lo que quieres que SCHOLARK cree…','Décrivez exactement ce que vous voulez que SCHOLARK crée…','Beschreibe genau, was SCHOLARK erstellen soll…','Descreva exatamente o que quer que o SCHOLARK crie…','Descrivi esattamente cosa vuoi che SCHOLARK crei…'],
    ['Add references','Referenties toevoegen','Añadir referencias','Ajouter des références','Referenzen hinzufügen','Adicionar referências','Aggiungi riferimenti'],
    ['No reference files added','Geen referentiebestanden toegevoegd','No se añadieron archivos de referencia','Aucun fichier de référence ajouté','Keine Referenzdateien hinzugefügt','Nenhum ficheiro de referência adicionado','Nessun file di riferimento aggiunto'],
    ['Build outline first','Bouw eerst de opzet','Crear primero el esquema','Construire d’abord le plan','Zuerst Gliederung erstellen','Criar primeiro a estrutura','Crea prima la struttura'],
    ['Generate complete first draft','Genereer complete eerste versie','Generar primer borrador completo','Générer un premier brouillon complet','Vollständigen ersten Entwurf erstellen','Gerar primeiro rascunho completo','Genera una prima bozza completa'],
    ['Quality pipeline','Kwaliteitspipeline','Pipeline de calidad','Pipeline qualité','Qualitätspipeline','Pipeline de qualidade','Pipeline di qualità'],
    ['SCHOLARK plans before it drafts, then checks the result before you edit.','SCHOLARK plant vóór het schrijft en controleert het resultaat voordat jij bewerkt.','SCHOLARK planifica antes de redactar y revisa el resultado antes de que edites.','SCHOLARK planifie avant de rédiger puis vérifie le résultat avant votre modification.','SCHOLARK plant vor dem Entwurf und prüft das Ergebnis vor deiner Bearbeitung.','O SCHOLARK planeia antes de escrever e verifica o resultado antes de editar.','SCHOLARK pianifica prima di scrivere e controlla il risultato prima della modifica.'],
    ['Live outline preview','Live voorbeeld van de opzet','Vista previa del esquema','Aperçu du plan en direct','Live-Gliederungsvorschau','Pré-visualização da estrutura','Anteprima live della struttura'],
    ['Your outline will appear here.','Je opzet verschijnt hier.','Tu esquema aparecerá aquí.','Votre plan apparaîtra ici.','Deine Gliederung erscheint hier.','A sua estrutura aparecerá aqui.','La tua struttura apparirà qui.'],
    ['Untitled project','Naamloos project','Proyecto sin título','Projet sans titre','Unbenanntes Projekt','Projeto sem título','Progetto senza titolo'],
    ['Saved','Opgeslagen','Guardado','Enregistré','Gespeichert','Guardado','Salvato'],
    ['Open saved Studio work directly. Autosaves are deduplicated, so one project no longer appears over and over.','Open opgeslagen Studio-werk direct. Autosaves worden samengevoegd zodat één project niet steeds opnieuw verschijnt.','Abre directamente trabajos guardados de Studio. Los autoguardados se deduplican para que un proyecto no aparezca repetido.','Ouvrez directement les travaux Studio enregistrés. Les sauvegardes automatiques sont dédupliquées pour éviter les doublons.','Öffne gespeicherte Studio-Arbeiten direkt. Autosaves werden dedupliziert, damit Projekte nicht mehrfach erscheinen.','Abra diretamente trabalhos guardados do Studio. Os autosaves são deduplicados para evitar projetos repetidos.','Apri direttamente i lavori Studio salvati. I salvataggi automatici vengono deduplicati per evitare duplicati.'],
    ['No saved projects yet. Create something in Studio AI and save it; it will appear here.','Nog geen opgeslagen projecten. Maak iets in Studio AI en sla het op; dan verschijnt het hier.','Aún no hay proyectos guardados. Crea algo en Studio AI y guárdalo; aparecerá aquí.','Aucun projet enregistré. Créez quelque chose dans Studio AI et enregistrez-le ; il apparaîtra ici.','Noch keine gespeicherten Projekte. Erstelle etwas in Studio AI und speichere es; dann erscheint es hier.','Ainda não há projetos guardados. Crie algo no Studio AI e guarde-o; aparecerá aqui.','Nessun progetto salvato. Crea qualcosa in Studio AI e salvalo; apparirà qui.'],
    ['Delete project','Project verwijderen','Eliminar proyecto','Supprimer le projet','Projekt löschen','Eliminar projeto','Elimina progetto'],
    ['Playful foundations, language and number sense','Speelse basis, taal en getalbegrip','Bases lúdicas, lenguaje y sentido numérico','Bases ludiques, langage et sens des nombres','Spielerische Grundlagen, Sprache und Zahlenverständnis','Bases lúdicas, linguagem e sentido numérico','Basi ludiche, lingua e senso dei numeri'],
    ['Math, language, exploration and smart practice','Rekenen, taal, ontdekken en slim oefenen','Matemáticas, lenguaje, exploración y práctica inteligente','Maths, langue, exploration et pratique intelligente','Mathematik, Sprache, Entdecken und kluges Üben','Matemática, linguagem, exploração e prática inteligente','Matematica, lingua, esplorazione e pratica intelligente'],
    ['Mastery, planning, study space and challenging subjects','Beheersing, planning, studieruimte en uitdagende vakken','Dominio, planificación, espacio de estudio y materias exigentes','Maîtrise, planification, espace d’étude et matières exigeantes','Beherrschung, Planung, Lernraum und anspruchsvolle Fächer','Domínio, planeamento, espaço de estudo e disciplinas desafiantes','Padronanza, pianificazione, spazio di studio e materie impegnative'],
    ['Research, reports, presentations and study planning','Onderzoek, verslagen, presentaties en studieplanning','Investigación, informes, presentaciones y planificación del estudio','Recherche, rapports, présentations et planification des études','Recherche, Berichte, Präsentationen und Studienplanung','Pesquisa, relatórios, apresentações e planeamento de estudos','Ricerca, relazioni, presentazioni e pianificazione dello studio'],
    ['Digital skills, work skills and practical help','Digitale vaardigheden, werkvaardigheden en praktische hulp','Habilidades digitales, laborales y ayuda práctica','Compétences numériques, professionnelles et aide pratique','Digitale Kompetenzen, Arbeitsfähigkeiten und praktische Hilfe','Competências digitais, profissionais e ajuda prática','Competenze digitali, lavorative e aiuto pratico']
  ].forEach(r=>add(...r));
  ...
  const canonicalLanguageLabels=['Dutch','English','Spanish','French','Deutch','Portugues','Italian'];
  function canonicalOptions(){return LANGS.map(([v,n])=>'<option value="'+v+'">'+n+'</option>').join('')}
  function selectorIsCanonical(sel){
    if(!sel||sel.options.length!==LANGS.length)return false;
    return LANGS.every(([v,n],i)=>sel.options[i]?.value===v&&clean(sel.options[i]?.textContent)===n);
  }
  ...
  function upgradeSelectors(){
    const options=canonicalOptions(),val=code();
    for(const sel of [$('#v55-language'),$('#v36-language'),$('#v89-lang')].filter(Boolean)){
      if(!selectorIsCanonical(sel)){sel.innerHTML=options}
  ...
  function scheduleLanguageCompletion(target,epoch){
    ...
    if(isHomeRoute()||target==='en')return;
    const run=async()=>{
      ...
      try{
        ...
        if(!missing.length){applyVisible();return}
    ...
    // Dynamic Workspace panels can mount just after the first pass.
  ...
  async function changeLanguage(target){
    ...
    // Preserve the running homepage cinematic. Switching UI language must not
    // stop timers, reset the active creator mode or pause CSS animation progress.
  ...
  window.__SCHOLARK_I18N__={langs:LANGS.map(x=>[x[0],x[1]]),languageName,nativeName,code,changeLanguage,apply:applyKnown,translateMissing:fillUnknown,translateCurrentPage,translateStrings,syncSelectors:upgradeSelectors,selectorIsCanonical,selftest:i18nSelftest,count:LANGS.length};
})();