(() => {
  ...
  function health(){
    ...
    const report={
      ok:true,release:'r190',home:home(),route:route(),activeMode:mode,previewMode,stageMode,statusModes,
    ...
    try{sessionStorage.setItem('scholark_foundation_r190',JSON.stringify(report))}catch{}
  ...
  window.__SCHOLARK_HOME_FOUNDATION__={repair:schedule,health,repairLocalization,repairProject,repairStudio,prewarmStudio,release:'r190',documentWideObserver:false};
})();
