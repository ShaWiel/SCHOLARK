(() => {
  ...
  function health(){
    ...
    try{sessionStorage.setItem('scholark_home_foundation_r127',JSON.stringify(report))}catch{}
  ...
  window.__SCHOLARK_HOME_FOUNDATION__={repair:schedule,health,release:'r127'};
})();
