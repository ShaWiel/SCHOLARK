(() => {
  ...
  function health(){
    ...
    try{sessionStorage.setItem('scholark_home_foundation_r129',JSON.stringify(report))}catch{}
  ...
  addEventListener('scholark-language-applied',()=>schedule(15));
  addEventListener('scholark-language-ready',()=>{schedule(35);setTimeout(health,220)});
  ...
  window.__SCHOLARK_HOME_FOUNDATION__={repair:schedule,health,release:'r129'};
})();
