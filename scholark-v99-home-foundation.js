(() => {
  ...
  function health(){
    ...
    const report={
      ok:true,release:'r193',home:home(),route:route(),activeMode:mode,previewMode,stageMode,statusModes,
    ...
    try{sessionStorage.setItem('scholark_foundation_r193',JSON.stringify(report))}catch{}
  ...
  window.__SCHOLARK_HOME_FOUNDATION__={repair:schedule,health,repairLocalization,repairProject,repairStudio,prewarmStudio,release:'r193',documentWideObserver:false};
})();
