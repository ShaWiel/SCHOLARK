(() => {
  ...
  function createEmergency(){
    ...
    root.innerHTML=`<aside class="v53-side"><div class="v53-brand">SCHOLARK<small>WORKSPACE</small></div><div class="v53-nav">
      <button class="active" data-v53-tool="dashboard">⌂ Dashboard</button><button data-v53-tool="studio">✦ Studio AI</button><button data-v53-tool="tutor">AI Tutor</button><button data-v53-tool="education">Education & Learning</button><button data-v53-tool="planner">Planner</button><button data-v53-tool="progress">Progress</button><button data-v53-tool="goal">Goals</button><button data-v53-tool="project">My Projects</button><button data-v53-tool="schools">Schools Near Me</button><button data-v53-tool="study">Study Ahead</button><button data-v53-tool="book">Book Studio</button>
      ...
      <button class="v53-card" data-v53-tool="education"><h3>Education & Learning</h3><p>Diagnostics, learning paths and mastery support.</p><b>OPEN LEARNING →</b></button>
