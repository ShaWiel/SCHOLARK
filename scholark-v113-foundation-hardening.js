(() => {
  ...
  function verify(){
    ...
    const result={
      ...
      release:"r185",route:r,workspace:work,rootLocked,qualityBadge:quality,unifiedFeature,visualReport,
  ...
  const foundationApi={version:"20260924-r185",repair:()=>repair(true),verify,errors:()=>errors.filter(x=>Date.now()-x.at<300000).slice(),safeStorage,fetchJson};
