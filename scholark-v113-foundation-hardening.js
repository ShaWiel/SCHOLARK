(() => {
  ...
  function verify(){
    ...
    const result={
      ...
      release:"r190",route:r,workspace:work,rootLocked,qualityBadge:quality,unifiedFeature,visualReport,
  ...
  const foundationApi={version:"20260924-r190",repair:()=>repair(true),verify,errors:()=>errors.filter(x=>Date.now()-x.at<300000).slice(),safeStorage,fetchJson};
