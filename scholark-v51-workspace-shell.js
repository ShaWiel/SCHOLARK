(() => {
  ...
  const workspaceRoute=()=>/dashboard|studio|tutor|education|language|planner|progress|goal|project|files|schools|study|book|presentation|webpage|document|report|graphic|social/.test(route());
  ...
  function openStudio(){
    ...
    if(s){
      ...
      idle(()=>window.__SCHOLARK_I18N__?.apply?.(s),{timeout:250});
      return
    }
    showFallback('studio')
  }
