(() => {
  ...
  style.textContent=`
    ...
    @media(max-width:1180px){body:not(.v51-collapsed){--v51-side:220px}.v51-grid{grid-template-columns:repeat(auto-fit,minmax(220px,1fr))}.v51-card.primary{grid-column:1/-1}.v51-levels{grid-template-columns:repeat(auto-fit,minmax(160px,1fr))}.v51-head{padding-right:0}}
