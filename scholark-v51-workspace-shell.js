(() => {
  ...
  style.textContent=`
    ...
    @media(max-width:1050px){body:not(.v51-collapsed){--v51-side:220px}.v51-grid{grid-template-columns:repeat(2,1fr)}.v51-card.primary{grid-column:span 2}.v51-levels{grid-template-columns:repeat(2,minmax(0,1fr))}.v51-head{padding-right:0}}
