(() => {
  ...
  function upsertMastery(input={}){
    ...
    row.updatedAt=new Date().toISOString();write(KEYS.mastery,rows);record('education','mastery_update',{id:row.id,subject,topic,mastery:row.mastery});return row;
  }
