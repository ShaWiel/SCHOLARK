(() => {
  ...
  function priceMarkup(){return `<div class="v41-price-head"><small>SCHOLARK PLANS</small><h2>Choose how much advantage you want.</h2><p>Every plan uses the same SCHOLARK foundation. Upgrade when you need heavier Studio creation, long-form work, future-study tools and higher usage limits.</p></div><div class="v41-price-grid">
    <article class="v41-plan"><div class="v41-kicker">FREE</div><h3>SCHOLARK Free</h3><div class="v41-desc">For everyday learning, practice and planning.</div><div class="v41-price">$0 <small>/ month</small></div><div class="v41-trial">No payment method required.</div><ul>
      <li>AI Tutor with step-by-step lessons</li><li>Diagnostics, Mastery & Spaced Review</li><li>Planner, Goals & Progress</li><li>Files & Notes analysis</li><li>Language Learner: vocabulary, grammar, listening & speaking practice</li><li>7-language interface</li><li>30 included AI credits/month</li><li>Credits are spent only on AI-heavy actions</li>
    ...
    <article class="v41-plan plus"><div class="v41-kicker">PLUS</div><h3>SCHOLARK Plus</h3><div class="v41-desc">For learners and creators who use Studio AI regularly.</div><div class="v41-price">$14.99 <small>/ month</small></div><div class="v41-trial">7 days free, then $14.99/month. Cancel anytime.</div><ul>
      <li>Everything in Free</li><li>Studio AI: Presentation, Webpage, Document, Social & Graphic</li><li>Research + citations and web sources</li><li>Cloud projects + version history</li><li>Advanced Files & Notes: Ask Files, worksheets and study tools</li><li>Max 4 active creations per Studio type</li><li>Natural Rewrite + priority creation</li><li>750 included AI credits/month</li><li>Higher fair-use limits</li>
    </ul><button data-plan="plus">Start Plus free trial</button></article>
    <article class="v41-plan pro"><span class="v41-most">MOST POPULAR</span><div class="v41-kicker">PRO</div><h3>SCHOLARK Pro</h3><div class="v41-desc">Maximum AI quality, large projects and future-study tools.</div><div class="v41-price">$19.99 <small>/ month</small></div><div class="v41-trial">7 days free, then $19.99/month. Cancel anytime.</div><ul>
      <li>Everything in Plus</li><li>Highest-quality SCHOLARK AI</li><li>Generous Studio + Natural Rewrite with fair-use guardrails</li><li>Presentations up to 100 slides</li><li>Documents/reports up to 100 pages</li><li>Book Studio beta: architecture + chapter-by-chapter writing</li><li>All genres + custom blends</li><li>Schools Near Me + Study Ahead</li><li>2,500 included AI credits/month</li><li>Priority access to stronger models for complex work</li>
    </ul><button data-plan="pro">Start Pro free trial</button></article></div>`;}
  let priceTimer=null;
