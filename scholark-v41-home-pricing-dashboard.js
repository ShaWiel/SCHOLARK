(() => {
  ...
  function ensureProTools(){const inner=findSidebarInner();if(!inner)return;let box=$('#v41-sidebar-pro');if(!box){box=document.createElement('div');box.id='v41-sidebar-pro';box.innerHTML='<div class="title">PRO TOOLS</div><button class="v41-side" data-v41="book">📚 <span>Book Studio</span><em>BETA</em></button><button class="v41-side" data-v41="schools">⌖ <span>Schools Near Me</span><em>PRO</em></button><button class="v41-side" data-v41="study">↗ <span>Study Ahead</span><em>PRO</em></button>';inner.appendChild(box);box.querySelector('[data-v41="book"]').onclick=()=>openTool('book');box.querySelector('[data-v41="schools"]').onclick=()=>openTool('schools');box.querySelector('[data-v41="study"]').onclick=()=>openTool('study');}}
