(() => {
  ...
  function priceMarkup(){return `<div class="v41-price-head"><small>SCHOLARK PLANS</small><h2>Choose how much advantage you want.</h2><p>Every plan uses the same SCHOLARK foundation. Upgrade when you need more AI usage, deeper research, cloud project capacity and future-study tools.</p></div><div class="v41-price-grid">
    <article class="v41-plan"><div class="v41-kicker">FREE</div><h3>SCHOLARK Free</h3><div class="v41-desc">For everyday learning, practice, planning and AI support.</div><div class="v41-price">$0 <small>/ month</small></div><div class="v41-trial">No payment method required.</div><ul>
      <li>ARKI general AI + AI Tutor</li><li>Education & Learning: diagnostics, Mastery & Spaced Review</li><li>Planner, Focus Sessions, Goals & Progress</li><li>Flashcards + Assignments</li><li>Files & Notes analysis</li><li>Language Learner: vocabulary, grammar, listening & speaking practice</li><li>My Projects workspace</li><li>7-language interface</li><li>30 included AI credits/month</li>
    </ul><button data-plan="free">Start free</button></article>
    <article class="v41-plan plus"><div class="v41-kicker">PLUS</div><h3>SCHOLARK Plus</h3><div class="v41-desc">For learners who need more AI usage, research and project capacity.</div><div class="v41-price">$14.99 <small>/ month</small></div><div class="v41-trial">7 days free, then $14.99/month. Cancel anytime.</div><ul>
      <li>Everything in Free</li><li>Research + citations and web sources</li><li>Cloud projects + version history</li><li>Advanced Files & Notes: Ask Files, worksheets and study tools</li><li>More room for ARKI, AI Tutor and learning workflows</li><li>750 included AI credits/month</li><li>Higher fair-use limits</li>
    </ul><button data-plan="plus">Start Plus free trial</button></article>
    <article class="v41-plan pro"><span class="v41-most">MOST POPULAR</span><div class="v41-kicker">PRO</div><h3>SCHOLARK Pro</h3><div class="v41-desc">For intensive learning, future-study tools and the highest usage limits.</div><div class="v41-price">$19.99 <small>/ month</small></div><div class="v41-trial">7 days free, then $19.99/month. Cancel anytime.</div><ul>
      <li>Everything in Plus</li><li>Schools Near Me: country- and level-aware school discovery</li><li>Study Ahead: AI roadmap connected to Planner, Mastery & Goals</li><li>2,500 included AI credits/month</li><li>Highest fair-use limits</li>
