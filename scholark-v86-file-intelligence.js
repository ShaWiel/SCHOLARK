(() => {
  ...
  function render(){
    ...
    h.innerHTML='<div class="v86"><div class="v52-kicker">SCHOLARK · FILE INTELLIGENCE</div><h1>Upload once. Turn it into useful work.</h1><p>PDF, DOCX, PPTX, TXT, Markdown, CSV, JSON and images can live in the workflow. Readable documents can immediately become summaries, explanations, quizzes, flashcards, notes, study plans or grounded context for ARKI and AI Tutor.</p><div class="v86-grid"><section class="v86-card"><label class="v86-drop"><b>＋ Add files</b><span>Up to 8 files · max 10 MB each</span><input id="v86-files" type="file" multiple accept=".pdf,.docx,.pptx,.txt,.md,.markdown,.csv,.json,.html,.htm,.xml,image/*"></label><div class="v86-list" id="v86-list"></div><div class="v86-actions" id="v86-actions"><button data-v86="summary">Summarize</button><button data-v86="explain">Explain</button><button data-v86="quiz">Quiz</button><button class="alt" data-v86="flashcards">Flashcards</button><button class="alt" data-v86="notes">Notes</button><button class="alt" data-v86="plan">Study plan</button><button class="alt" data-v86="concepts">Key concepts</button><button class="alt" data-v86="worksheet">Worksheet</button></div><div class="v86-ask"><input id="v86-question" placeholder="Ask a question about the uploaded material…"><button type="button" data-v86="ask">Ask files</button></div><div class="v86-tools"><button type="button" id="v86-copy">Copy result</button><button type="button" id="v86-clear">Clear files</button></div><div class="v86-stat" id="v86-stat"></div><div class="v86-status" id="v86-status"></div></section><section class="v86-card v86-output" id="v86-output"><h3>Ready when you are.</h3>Upload study material, a report, slides, notes or data. SCHOLARK will keep the workflow grounded in what you supplied.</section></div></div>';
  ...
  window.__SCHOLARK_V86_FILES__={open:render,refresh:render};
})();